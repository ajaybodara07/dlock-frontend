...
import UserCard from "./AircraftCard";
...
const Row = (props) => {
  ...
  const getAircraftStatus = (status) => {
    console.log(status,"status-----------")
    if (status === "service_complete") {
      return "Complete";
    } else if (status === "in_parking") {
      return "In Parking";
    ...
    <React.Fragment>
      ...
      >
        ...
        <TableCell className={classes.tableCell} component="th">
          {row.aircraftClientName}
        </TableCell>
        <TableCell className={classes.tableCell} align="left">
          {row.aircraftManufacturer}
        </TableCell>
        <TableCell className={classes.tableCell} align="left">
          {row.aircraftModel}
        </TableCell>
        ...
        <TableCell className={classes.tableCell} align="left">
          {getAircraftStatus(row.aircraftStatus)}
        </TableCell>
      ...
      <TableRow>
        ...
        >
          ...
          >
            <ItemTable itemID={row.itemID} items={items} />
          </Collapse>
        </TableCell>
      </TableRow>
    </React.Fragment>
  ...
  return (
    <div className={classes.root}>
            ...
            <Form>
              <Grid container spacing={2} direction="column">
                ...
                <Grid item>
                  ...
                  >
                    <InputLabel id="aircraft-model">Aircraft Status</InputLabel>
                    <Select
                      name="status"
                      ...
                      required
                    >
                      <MenuItem value="in_parking">In Parking</MenuItem>
      ...
      >
        <Formik
          initialValues={{
            customer: currentRow?.aircraftClientName || "",
            manufacturer: currentRow?.aircraftManufacturer || "",
            model: currentRow?.aircraftModel || "",
            status: currentRow?.aircraftStatus || "",
          }}
          onSubmit={async (values) => {
            await editAircraft({
              reg: currentRow?.aircraftReg || "",
              customer: values.customer,
              manufacturer: values.manufacturer,
              model: values.model,
              status: values.status,
                ...
                <Grid item>
                  ...
                  >
                    ...
                    >
                      <MenuItem value="in_parking">In Parking</MenuItem>
                      <MenuItem value="in_maintenance">In Maintenance</MenuItem>
                      <MenuItem value="service_complete">Complete</MenuItem>
                    </Select>
                  </FormControl>
                </Grid>
              </Grid>
      ...
      <Modal open={deleteAircraftModal} setOpen={setDeleteAircraftModal}>
        <Formik
          ...
          onSubmit={async (values) => {
            console.log("delete");
            const kkk = await deleteAircraft({
              reg: currentRow?.aircraftReg || "",
              siteID: id,
            });
            console.log("kkk", kkk);
          ...
          {({ values, handleChange, isSubmitting }) => (
            <Form>
              <Typography variant="h6" align="center">
                {`Are you sure you want to delete Aircraft ${currentRow?.aircraftReg}`}
              </Typography>
              <Grid
                container
                spacing={2}
    ...
    <Toolbar className={clsx(classes.root)}>
      ...
      >
        ...
        >
          ...
          <MenuItem value="aircraftManufacturer">
            Aircraft Manufacturer
          </MenuItem>
          <MenuItem value="aircraftModel">Aircraft Model</MenuItem>
          <MenuItem value="aircraftReg">Aircraft Reg</MenuItem>
          <MenuItem value="aircraftStatus">Aircraft Status</MenuItem>
        </Select>
      </FormControl>
      <SearchBar
